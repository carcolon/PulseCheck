...
public sealed class WindowsPromptService : ICampaignPromptService
{
    ...
    private sealed class PulsePromptForm : Form
    {
        ...
        private static readonly Color CompanyDeep = Color.FromArgb(7, 53, 68);
        private static readonly Color CompanyTeal = Color.FromArgb(0, 117, 141);
        private static readonly Color CompanyBlue = Color.FromArgb(0, 138, 171);
        private static readonly Color CompanyOrange = Color.FromArgb(238, 118, 35);
        ...
        private void RenderScaleQuestion(AgentQuestion question)
        {
            ...
            if (totalOptions <= 10)
            {
                ...
                for (var value = min; value <= max; value++)
                {
                    ...
                    button.FlatAppearance.MouseOverBackColor = CompanyTeal;
                    button.FlatAppearance.MouseDownBackColor = CompanyDeep;
        ...
        private void RenderYesNoQuestion(AgentQuestion question)
        {
            ...
            yesButton.FlatAppearance.MouseOverBackColor = CompanyTeal;
            yesButton.FlatAppearance.MouseDownBackColor = CompanyDeep;
        ...
        private static ElementHost CreateChoiceOptionHost(string text, int width, int height, Action onClick)
        {
            var textBlock = new System.Windows.Controls.TextBlock
            {
                ...
                Foreground = new System.Windows.Media.SolidColorBrush(ToMediaColor(CompanyDeep))
            };
