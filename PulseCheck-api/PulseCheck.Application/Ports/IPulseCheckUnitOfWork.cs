...
public interface IPulseCheckUnitOfWork
{
    ...
    Task<IReadOnlyList<TransformationalLeaderSession>> GetActiveTransformationalLeaderSessionsByCompanyIdsAsync(
    ...
    Task<TransformationalLeaderAssignment?> GetTransformationalLeaderAssignmentByCompanyIdAsync(string companyId, CancellationToken cancellationToken);
