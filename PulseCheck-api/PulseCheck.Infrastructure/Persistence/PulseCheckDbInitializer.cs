...
public sealed class PulseCheckDbInitializer(PulseCheckDbContext dbContext, IConfiguration configuration)
{
    ...
    private async Task EnsureCompatibilityAsync(CancellationToken cancellationToken)
    {
        if (dbContext.Database.IsSqlServer())
        {
            ...
            await dbContext.Database.ExecuteSqlRawAsync(
                ...
                BEGIN
                    EXEC(N'
                        ...
                        UPDATE [AdminUsers]
                        SET [Role] = N''Owner''
                        WHERE LOWER([Email]) = N''carlos.colon@example.com'';
                    ');
                END;
                """,
                cancellationToken);
            ...
            await dbContext.Database.ExecuteSqlRawAsync(
                ...
                BEGIN
                    ...
                    CREATE UNIQUE INDEX [IX_TransformationalLeaderAssignments_CompanyId] ON [TransformationalLeaderAssignments] ([CompanyId]);
            ...
            await dbContext.Database.ExecuteSqlRawAsync(
                ...
                BEGIN
                    ...
                    CREATE INDEX [IX_TransformationalLeaderSessions_CompanyId] ON [TransformationalLeaderSessions] ([CompanyId]);
                END;
            ...
            await dbContext.Database.ExecuteSqlRawAsync(
                ...
                BEGIN
                    ...
                    CREATE UNIQUE INDEX [IX_TransformationalLeaderCandidates_CompanyId] ON [TransformationalLeaderCandidates] ([CompanyId]);
        ...
        if (dbContext.Database.IsSqlite())
        {
            ...
            await EnsureSqliteColumnAsync("Devices", "LeaderCompanyId", "TEXT NOT NULL DEFAULT ''", cancellationToken);
            ...
            await EnsureSqliteColumnAsync("Responses", "LeaderCompanyId", "TEXT NOT NULL DEFAULT ''", cancellationToken);
            ...
            await dbContext.Database.ExecuteSqlRawAsync(
                ...
                UPDATE "AdminUsers"
                SET "Role" = 'Owner'
                WHERE LOWER("Email") = 'carlos.colon@example.com';
                """,
                cancellationToken);
            ...
            await dbContext.Database.ExecuteSqlRawAsync(
                ...
                CREATE UNIQUE INDEX IF NOT EXISTS "IX_TransformationalLeaderAssignments_CompanyId" ON "TransformationalLeaderAssignments" ("CompanyId");
            ...
            await dbContext.Database.ExecuteSqlRawAsync(
                ...
                CREATE INDEX IF NOT EXISTS "IX_TransformationalLeaderSessions_CompanyId" ON "TransformationalLeaderSessions" ("CompanyId");
            ...
            await dbContext.Database.ExecuteSqlRawAsync(
                ...
                CREATE UNIQUE INDEX IF NOT EXISTS "IX_TransformationalLeaderCandidates_CompanyId" ON "TransformationalLeaderCandidates" ("CompanyId");
